    ...
    <Box sx={{ width: "516px" }}>
      <Stack sx={{ padding: "10px" }}>
        ...
        <Box sx={{ marginTop: "10px" ,display:"flex"}}>
          <Box>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate fugit officia ipsa libero, et repudiandae, suscipit quo aspernatur dolore quas modi est voluptas rem deserunt labore sed, cumque maiores ea!
          </Box>
